...
@ManagedBean(name = "itSupportData", eager = true)
@RequestScoped
public class ITSupportReg {
	...
	//Storing IT user data into Mysql database
		...
		public String storeSupportData()
		{
		...
		String sql = "INSERT INTO itsupportregdata(FirstName,MiddleName,LastName,EmailID,Phone,Address1,Address2,TimeStamp) VALUES(?,?,?,?,?,?,?,?)";
